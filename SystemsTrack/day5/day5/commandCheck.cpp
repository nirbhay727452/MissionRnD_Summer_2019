...
int validCommandName(char* commandname){
	char** commands = (char**)malloc(sizeof(char*) * 9);
	commands[0] = "init";
	commands[1] = "workingdays";
	commands[2] = "startingday ";
	commands[3] = "workinghours";
	commands[4] = "addPeople";
	commands[5] = "addevent";
	commands[6] = "listEvents";
	commands[7] = "iseventpossible";
	commands[8] = "next3possibleslots";
